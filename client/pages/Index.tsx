      ...
      <section className="py-20 bg-polaris-surface">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to="/bags">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105 border-polaris-divider">
                <CardHeader className="text-center space-y-4">
                  <div className="mx-auto w-16 h-16 bg-brand-purple/10 rounded-full flex items-center justify-center group-hover:bg-brand-purple group-hover:text-white transition-colors">
                    <ShoppingBag className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-xl">Hand Bags</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Link to="/crafts">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105 border-polaris-divider">
                <CardHeader className="text-center space-y-4">
                  <div className="mx-auto w-16 h-16 bg-brand-yellow/10 rounded-full flex items-center justify-center group-hover:bg-brand-yellow group-hover:text-white transition-colors">
                    <Sparkles className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-xl">DIY Crafts</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-center">
            ...
            <Link to="/perfumes">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105 border-polaris-divider">
                <CardHeader className="text-center space-y-4">
                  <div className="mx-auto w-16 h-16 bg-brand-teal/10 rounded-full flex items-center justify-center group-hover:bg-brand-teal group-hover:text-white transition-colors">
                    <Heart className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-xl">Perfumes</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-center">
            ...
            <Link to="/jewelry">
              <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105 border-polaris-divider">
                <CardHeader className="text-center space-y-4">
                  <div className="mx-auto w-16 h-16 bg-brand-orange/10 rounded-full flex items-center justify-center group-hover:bg-brand-orange group-hover:text-white transition-colors">
                    <Star className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-xl">Jewelry</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300">
              <div className="aspect-square bg-gradient-to-br from-brand-purple/10 to-brand-yellow/10 rounded-t-lg relative overflow-hidden">
                <div className="absolute inset-0 bg-polaris-surface-subdued flex items-center justify-center">
                  <ShoppingBag className="h-16 w-16 text-brand-purple/30" />
                </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-polaris-text-subdued text-sm">
                    Handwoven tote bag with traditional patterns and modern functionality
                  </p>
            ...
            {/* Product Card 2 */}
            <Card className="group hover:shadow-xl transition-all duration-300">
              <div className="aspect-square bg-gradient-to-br from-brand-teal/10 to-brand-orange/10 rounded-t-lg relative overflow-hidden">
                <div className="absolute inset-0 bg-polaris-surface-subdued flex items-center justify-center">
                  <Star className="h-16 w-16 text-brand-teal/30" />
                </div>
                <div className="absolute top-4 right-4">
                  <Button variant="ghost" size="sm" className="bg-white/80 hover:bg-white">
                    <Heart className="h-4 w-4" />
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-polaris-text-subdued text-sm">
                    Beautifully crafted jewelry set with matching earrings
                  </p>
                  <div className="flex items-center justify-between">
            ...
            {/* Product Card 3 */}
            <Card className="group hover:shadow-xl transition-all duration-300">
              <div className="aspect-square bg-gradient-to-br from-brand-yellow/10 to-brand-green/10 rounded-t-lg relative overflow-hidden">
                <div className="absolute inset-0 bg-polaris-surface-subdued flex items-center justify-center">
                  <Heart className="h-16 w-16 text-brand-yellow/30" />
                </div>
                <div className="absolute top-4 right-4">
                  <Button variant="ghost" size="sm" className="bg-white/80 hover:bg-white">
                    <Heart className="h-4 w-4" />
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  ...
                  <p className="text-polaris-text-subdued text-sm">
                    Exclusive fragrance blend with notes of jasmine and sandalwood
                  </p>
                  <div className="flex items-center justify-between">
                    <span className="text-xl font-bold text-brand-purple">$65</span>
                    <Button size="sm" className="bg-brand-purple hover:bg-brand-purple/90">
                      Add to Cart
                    </Button>
                  </div>
